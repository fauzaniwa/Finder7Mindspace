    ...
    <div class="flex flex-col justify-center items-center pb-20">
        ...
        <div class="flex justify-center items-center py-12 px-5 bg-neutral-900 rounded-xl w-10/12 md:w-6/12">
            ...
            <form id="form" action="process_submitkarya.php" method="post" class="flex flex-col gap-5 w-full">
                ...
                <div class="relative">
                    <!-- <div class="absolute w-full h-10 flex justify-end items-center pr-4">
                        <button class=" bg-white rounded-md w-24 p-1 text-sm">
                            Upload
                        </button>
                    </div> -->
                     <p class="italic text-neutral-500 text-sm pt-2">
                    ...
                    <input type="file" id="buktipembayaran" name="Bukti_Pembayaran" accept="image/*" placeholder="Upload Bukti Pembayaran" required class="w-full text-white bg-neutral-800 rounded-lg px-4 py-2
                            file:ml-auto file:py-1 file:px-3 file:rounded-md file:border-0
                            file:text-sm file:font-semibold file:bg-emerald-400 file:text-black
                ...
                <div class="flex items-start gap-3 text-white text-sm">
                    ...
                    <label for="persetujuan">
                        Saya menyetujui <a href="wacomsubmission.php#ketentuan"
