<header class="fixed top-0 left-0 w-full backdrop-blur-lg p-5 z-20 shadow-sm">
    <div class="container mx-auto flex items-center justify-between">
        <a href="homepage.php" class="z-30"><img src="img/Finder 7 Logopack_Lockup Full White small.png" alt=""
                class="h-10 opacity-75 hover:opacity-100 transition-opacity" />
        </a>

        <!-- Nav Asli -->

        <nav class="hidden md:flex gap-6 justify-center font-medium text-white">
            <a href="homepage.php#finderdesc" style="font-family: 'Work Sans'" class="flex"><button>About</button></a>
            ...
            <a href="homepage.php#jadwal" style="font-family: 'Work Sans'" class="flex"><button>Jadwal</button></a>
            <a href="submission.php" style="font-family: 'Work Sans'" class="flex"><button>Lomba</button></a>
        </nav>
