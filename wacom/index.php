...
<body class="bg-black">
    ...
    <section class="hero relative min-h-screen px-4  flex items-center justify-center w-full mx-auto overflow-hidden ">
        ...
        <div class="justify-center flex flex-col items-center p-10 max-w-xl mx-auto py-72 ">
            ...
            <h1 class="text-white text-3xl md:text-5xl font-semibold text-center"> FINDER X WACOM</h1>
            <br><br>
        ...
        <section
            ...
            <div id="syarat"
                ...
                <ol
                    ...
                    <li>Peserta wajib mengunduh, mengisi, menandatangani dan mengunggah kembali Surat Pernyataan
                        ...
                        Luring.</li>
                    <li>Template surat-surat dapat diunduh di sini.</li>
            ...
            <div id="teknis"
                ...
                <ol
                    ...
                    <li>Seluruh finalis akan mendapatkan sertifikat cetak.</li>
                </ol>
                <br><br><br>
            </div>
        </section>
        ...
        <section
            ...
            <div id="desainkarakter"
                ...
                <table class="border-separate border-spacing-y-4 border-spacing-5 text-left text-white">
                    <tr>
                        ...
                        <td class="text-sm md:text-base text-justify align-top">Di Bulan Aku Menunggu</td>
                    </tr>

                    <tr>
                        <td class="font-bold text-sm md:text-xl align-top ">Penulis</td>
                        <td class="text-sm md:text-base text-justify align-top">Finder 7 Mindspace</td>
                    </tr>

                    <tr>
                        <td class="font-bold text-sm md:text-xl align-top ">Genre / Kategori</td>
                        <td class="text-sm md:text-base text-justify align-top">Fiksi, folklore, romantis, drama.</td>
                    </tr>

                    <tr>
                        <td class="font-bold text-sm md:text-xl align-top ">Target Audiens</td>
                        <td class="text-sm md:text-base text-justify align-top">Semua umur, pecinta cerita rakyat.</td>
                    </tr>

                    <tr>
                        <td class="font-bold text-sm md:text-xl align-top ">Sinopsis buku</td>
                        <td class="text-sm md:text-base text-justify align-top">Mengadaptasi dari cerita rakyat berjudul Nyai Anteh
                            Penunggu
                    ...
                    <tr>
                        ...
                        <td class="text-sm md:text-base text-justify align-top"> Dramatis, lembut, menyentuh, sedikit dark.</td>
                    </tr>

                    <tr>
                        <td class="font-bold text-sm md:text-xl align-top ">Referensi Visual</td>
                        <td class="text-sm md:text-base text-justify align-top">https://pin.it/1OzikV3vA</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-sm md:text-base text-justify align-top">Kombinasi hangat-dingin, dengan sentuhan romansa yang
                            menyayat
                            hati.</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-sm md:text-base text-justify align-top">Handwritten / cursive / dekoratif.</td>
                    </tr>

                    <tr>
                        <td class="font-bold text-sm md:text-xl align-top ">Format & Ukuran</td>
                        <td class="text-sm md:text-base text-justify align-top">13 x 19 cm, spine tebal 1,5 cm, margin safe area
                            kanan-kiri-atas-bawah 1 cm</td>
                    </tr>

                    <tr>
                        <td class="font-bold text-sm md:text-xl align-top ">Output yang diharapkan</td>
                        <td class="text-sm md:text-base text-justify align-top">PDF (CMYK 300dpi)</td>
                    </tr>
            ...
            <div id="poster"
                ...
                <table
                    ...
                    <tr>
                        <td class="font-bold text-sm md:text-xl align-top">Judul Buku</td>
                        <td class="text-sm md:text-base text-justify align-top">Pojok Ruang</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="font-bold text-sm md:text-xl align-top">Genre / Kategori</td>
                        <td class="text-sm md:text-base text-justify align-top">Fiksi, drama, psikologi</td>
                    </tr>

                    <tr>

                        <td class="font-bold text-sm md:text-xl align-top">Target Audiens</td>
                        <td class="text-sm md:text-base text-justify align-top">Semua umur, menjangkau orang-orang yang membutuhkan pemahaman
                    ...
                    <tr>
                        ...
                        <td class="font-bold text-sm md:text-xl align-top">Sinopsis buku</td>
                        <td class="text-sm md:text-base text-justify align-top">Mengulik sisi pikiran manusia yang rumit dengan storytelling
                            bak
                            novel. Di buku ini,
                    ...
                    <tr>
                        ...
                        <td class="font-bold text-sm md:text-xl align-top">Elemen Wajib</td>
                        <td class="text-sm md:text-base text-justify align-top">
                            <ol class="list-disc list-outside pl-4">
                    ...
                    <tr>
                        ...
                        <td class="font-bold text-sm md:text-xl align-top">Warna yang diharapkan</td>
                        <td class="text-sm md:text-base text-justify align-top">Menyesuaikan GSM Finder 7: Mindspace. Download di sini.</td>
                    </tr>
...
<script>
    ...
    const targetDate = new Date(Date.UTC(2025, 7, 24, 16, 59, 0));
